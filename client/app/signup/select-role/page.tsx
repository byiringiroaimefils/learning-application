...
export default function SelectRoleSignUp() {
  return (
    <>
      {/* ========== MAIN CONTENT ========== */}
      <main className="flex ou4zs max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-4 mb-4">
        {/* Sidebar */}
        <div className="hidden vvwug b2orr xcqoi f4yn1 lg:flex flex-col ox2cl jq72l dark:bg-neutral-950">
          {/* Header */}
          <div className="flex flex-wrap ox2cl items-center o4ndh">
            ...
            >
              ...
              >
                <path
                  ...
                  className="etvti dark:fill-blue-500"
                  fill="currentColor"
                />
                <path
                  fillRule="evenodd"
            ...
            <div className="relative">
              <Link href="/" className="s53ws sfv8v flex items-center b1nd2 s1lil z4zqw sqycf w9dei c9jt8 pb094 d05xb disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden r17tr dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800">
                Go Back
              </Link>
              {/* End Header */}
            </div>
          ...
          {/* Body */}
          <div>
            <span className="f8p8s sikx1 c9jt8 dark:text-white">
              The simplest way to manage your E-learnig Studies
            </span>
            <img
            ...
            <img
              ...
              src="../../assets/authentication-charts-dark.svg"
              alt="Charts Mockups"
            />
          </div>
          {/* End Body */}
          {/* Footer */}
          <div className="flex jkwm1 wd2w2">
            <svg
              className="fl6qw"
              width={81}
              height={20}
            ...
            >
              <g clipPath="url(#clip0_399_369933)">
                <path
                  ...
                  fill="currentColor"
                  className="cbb9g dark:fill-neutral-400"
                />
              </g>
              <defs>
        ...
        {/* End Sidebar */}
        {/* Content */}
        <div className="hlt95 ns57r">
          <div className="h1r77 vvwug jcysb flex flex-col jkwm1 mx-auto space-y-5">
            {/* Title */}
            <div>
              <h1 className="mp30q o0lhv cnneu c9jt8 dark:text-neutral-200">
              ...
              <div className="space-y-5">
                <div>
                  <label
                    ...
                    className="block wyf4w w4xo0 sikx1 c9jt8 dark:text-white"
                  >
                    Full name
                  </label>
                  <input
                    type="text"
                    id="hs-pro-dalfn"
                    className="s53ws nv7zt f2l40 block w-full lnk45 pb094 glhrq bj1nl y20ll vtle8 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute rm8lf kji94 flex items-center gbcuh f2l40 cursor-pointer rr36x ydigi focus:outline-hidden i4yyh dark:text-neutral-600 dark:focus:text-blue-500"
                      >
                        <svg
                ...
                <div className="flex items-center n9hej">
                  <input
                    type="checkbox"
                    className="e731n lnk45 h6zia m8zlk igv60 axcnw dark:bg-neutral-800 dark:checked:bg-blue-500 dark:border-neutral-700"
                    id="hs-pro-dsftac"
                  />
                  <label
                    htmlFor="hs-pro-dsftac"
                    className="w4xo0 c9jt8 dark:text-neutral-200"
                  >
                    I accept the
                    <a
                      className="inline-flex items-center b1nd2 sikx1 igv60 o4lej j3zsq f1348 dark:text-blue-500 dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600"
                      href="#"
                    >
                ...
                <button
                  type="button"
                  className="gdxvw f2l40 w-full inline-flex jkwm1 items-center n9hej w4xo0 cnneu pb094 rsdjd azddh owkrq kew0r qfc1d disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600"
                >
                  Sign up
                </button>
              </div>
            ...
            <p className="w4xo0 jy5gh dark:text-neutral-500">
              Have an account?
              <Link
                className="inline-flex items-center n6i5x w4xo0 igv60 j3zsq f1348 sikx1 focus:outline-hidden ow4j6 dark:text-blue-500 pl-2"
